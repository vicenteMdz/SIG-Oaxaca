...
namespace Sistema_de_Informacion_Geografico
{
    class UtilsConstants
    {
        ...
        public const string SQL_ALL_CAT_RIESGOS = "SELECT ID_CAT_RIESGO, NOMBRE_CATEORIA FROM [SIG_CAT_RIESGOS] ORDER BY NOMBRE_CATEORIA ASC;";

        public const string SQL_ALL_REGIONES = "SELECT ID_REGION, NOMBRE FROM [SIG_REGIONES] ORDER BY NOMBRE ASC;";

        public const string SQL_GET_DISTRITOS_BY_REGION = "SELECT ID_DISTRITO, NOMBRE FROM [SIG_DISTRITOS] "
            + "WHERE ID_REGION = @PARAMETER ORDER BY NOMBRE ASC;";

        public const string SQL_GET_MUNICIPIOS_BY_DISTRITOS = "SELECT ID_MUNICIPIOS, NOMBRE FROM [SIG_MUNICIPIOS] "
            + "WHERE ID_DISTRITO = @PARAMETER ORDER BY NOMBRE ASC;";

        public const string SQL_GET_POBLADOS_BY_MUNICIPIOS = "SELECT ID_POBLADO, NOMBRE FROM [SIG_POBLADOS] "
            + "WHERE ID_MUNICIPIO = @PARAMETER ORDER BY NOMBRE ASC;";
