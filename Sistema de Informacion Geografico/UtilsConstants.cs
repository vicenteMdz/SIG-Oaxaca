...
namespace Sistema_de_Informacion_Geografico
{
    class UtilsConstants
    {
        ...
        public const string SQL_COORDENADAS_BY_POBLACION = "SELECT ID_COORDENADA, LATITUD, LONGITUD "
            + "FROM SIG_COORDENADAS JOIN SIG_POBLADOS ON SIG_COORDENADAS.ID_POBLADO = SIG_POBLADOS.ID_POBLADO "
            + "WHERE SIG_COORDENADAS.LATITUD!=0 AND SIG_COORDENADAS.LONGITUD!=0 AND SIG_COORDENADAS.ID_POBLADO=@PARAMETER;";
    }
}
